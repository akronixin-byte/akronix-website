              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:akronix.in@gmail.com" className="text-white hover:text-cyan-700 transition-colors">akronix.in@gmail.com</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-cyan-700 shrink-0">
                  ...
                  <div>
                    ...
                    <div>
                      <a href="tel:+919360745895" className="text-white hover:text-cyan-700 transition-colors">+91 93607 45895</a>
                    </div>
                    <div>
                      <a href="tel:+919342424973" className="text-white hover:text-cyan-700 transition-colors">+91 93424 24973</a>
                    </div>
                  </div>
                </div>
              </div>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">Chennai<br />Tamil Nadu, India</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-cyan-700 shrink-0">
