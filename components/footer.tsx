...
const footerLinks = {
  ...
  // Legal links removed; replaced by a single 'Legal Service' content block rendered in the footer
};
    ...
    <footer className="border-t" style={{ borderColor: "rgba(255,255,255,0.07)", background: "rgba(15, 10, 60, 0.6)" }}>
      ...
      <div className="container-xl py-12">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          {/* Links (Services, Company, Resources) */}
          ...
          {/* Legal block: header + toggle for Legal Service content */}
          <LegalBlock />
        </div>
      </div>
